              ...
              ord.map((order) => (
                <tr key={order._id}>
                  ...
                  <th scope='col'>
                    ...
                    <td>
                      <i onClick={() => confirmOrderPayment(order._id)} class='fa-solid fa-dollar-sign' style={{ cursor: 'pointer', paddingLeft: '20px', color: 'green' }}></i>
                    </td>
                    <td>
                      <i onClick={() => orderDeliveredHome(order._id)} class='fa-solid fa-house-chimney' style={{ cursor: 'pointer', marginLeft: '20px' }}></i>
                    </td>
                    <td>
                      <i onClick={() => deleteOrder(order._id)} class='far fa-trash-alt btn-danger' style={{ cursor: 'pointer', marginLeft: '20px' }}></i>
                    </td>
                  </th>
                </tr>
              ))
