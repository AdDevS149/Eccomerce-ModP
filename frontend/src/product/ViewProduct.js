              ...
              <div className='img_div'>
                ...
                <div className='review' style={{ paddingTop: '10px' }}>
                  ...
                  {reviews && reviews.length === 0 && (
                    <>
                      <div class='alert alert-warning alert_warning_custom' role='alert' data-mdb-color='warning'>
                        {' '}
                        No review added yet{' '}
                      </div>
                    </>
            ...
            <div className='col-sm-6'>
              <div className='product_desc_wrapper'>
                ...
                <div className='qty_and_addtocart'>
                  <div>
                    <div onClick={decreaseValue} class='value-button' id='decrease' value='Decrease Value'>
                      -
                    </div>
                    <input type='number' id='number' value={qty} readOnly />
                    <div onClick={increaseValue} class='value-button' id='increase' value='Increase Value'>
                      +
                    </div>
                  </div>
