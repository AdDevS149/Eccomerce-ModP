...
const PaymentCart = (props) => {
  ...
  useEffect(() => {
    ...
    if (shippingAddress.cellPhone === '') {
      props.navigate('/shipping');
      toast.error('You must add a phone number');
    }
  }, [navigate, props, cart.itemsPrice, cart.shippingPrice, cart.taxPrice, cart.totalPrice, shippingAddress.address, shippingAddress.cellPhone]);
          ...
          <div className='row'>
            ...
            <div className='col-sm-4'>
              ...
              <div className='shipping_details text-center pt-3 mt-3'>
                ...
                <div className=''>
                  {' '}
                  <img className='img-fluid imgstripe_style' src={stripeCreditCard} alt='stripe payment' />
                </div>
