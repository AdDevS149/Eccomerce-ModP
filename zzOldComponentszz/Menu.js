      ...
      <nav className='navbar navbar-expand-lg navbar-light bg-light'>
        <div className='container-fluid'>
          ...
          <div className='d-flex align-items-center'>
            ...
            <Link className='text-reset me-3 dropdown-toggle hidden-arrow' to='/' id='navbarDropdownMenuLink' role='button' data-mdb-toggle='dropdown' aria-expanded='false'></Link>

            <Link className='dropdown-toggle d-flex align-items-center hidden-arrow' to='/' id='navbarDropdownMenuLink' role='button' data-mdb-toggle='dropdown' aria-expanded='false'>
              <span className='username'> {user ? user.name : 'Sign In'}</span>
              <img src={user && user.avatar ? user.avatar : avatar} className='rounded-circle' height='25' alt='' loading='lazy' />
            </Link>
