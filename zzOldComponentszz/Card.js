...
//             {' '}
//             <img src={product.avatar ? product.avatar : imgDefault} className='card-img img-fluid' width='96' height='350' alt='' />{' '}
//           </div>
//         </div>
...
//               {' '}
//               <Link to={`/product/${product._id}`} className='text-default mb-2' data-abc='true'>
//                 {product.name}
//               </Link>{' '}
//             </h5>{' '}
...
//           <button disabled={countStock === 0} onClick={() => addToCardHome(id, 1)} type='button' className='btn bg-cart'>
