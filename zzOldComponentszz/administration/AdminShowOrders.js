...
const AdminShowOrders = () => {
  ...
  return (
    <>
      ...
      <Menu />
      <div className='order_user_history paddingTB container' style={{ paddingLeft: '150px', paddingTop: '100px', minHeight: '550px' }}>
        <h2>Orders</h2>
              ...
              ord.map((order) => (
                <tr key={order._id}>
                  ...
                  <th scope='col'>
                    <td>
                      {' '}
                      <i data-mdb-toggle='modal' data-mdb-target='#exampleModal' style={{ cursor: 'pointer' }} onClick={() => singleOrderAdmin(order._id)} className='fa-regular fa-eye'></i>
                    </td>
                    <td>
                      <i onClick={() => confirmOrderPayment(order._id)} className='fa-solid fa-dollar-sign' style={{ cursor: 'pointer', paddingLeft: '20px', color: 'green' }}></i>
                    </td>
                    <td>
                      <i onClick={() => orderDeliveredHome(order._id)} className='fa-solid fa-house-chimney' style={{ cursor: 'pointer', marginLeft: '20px' }}></i>
                    </td>
                    <td>
                      <i onClick={() => deleteOrder(order._id)} className='far fa-trash-alt btn-danger' style={{ cursor: 'pointer', marginLeft: '20px' }}></i>
                    </td>
                  </th>
                </tr>
              ))
          ...
          <div className='modal-dialog'>
            <div className='modal-content'>
              <div className='modal-header'>
                <h5 style={{ color: 'white' }} className='modal-title' id='exampleModalLabel'>
                  Purchase Details
                </h5>
              ...
              <div className='modal-body'>
                      ...
                      singleOrder &&
                        singleOrder.map((det) => (
                          <tr key={det._id}>
                            ...
                            <th scope='col'>
                              <img style={{ maxWidth: '40%' }} src={det.image} alt={det.name} />
                            </th>
                ...
                <div className='shipping_details_info'>
                  ...
                  <ul>
                    ...
                    <li>
                      <b>Address: </b> {shippingAddressload.address}, {shippingAddressload.city}, {shippingAddressload.country}, {shippingAddressload.postalCode}
                    </li>
                    <li>
